...
export const workflowPageMeta = {
  analysis: {
    ...
    description: "把目标岗位或真实 JD 转换为职责、技能、关键词和评估标准。",
    nextHint: "完成岗位画像后，继续填写个人能力信息。",
  },
  assessment: {
    step: 2,
    title: "盘点你的能力，找到已经具备的优势",
    description: "结合目标岗位和真实经历，建立清晰、可比较的个人能力画像。",
    nextHint: "提交后查看岗位匹配度和关键能力差距。",
  },
  gap: {
    step: 3,
    title: "把差距排出优先级，先补最关键的一块",
    description: "对比岗位要求与个人能力，识别优势、风险和最值得优先补齐的能力。",
    nextHint: "将关键差距转换为阶段化学习路线。",
  },
  roadmap: {
    step: 4,
    title: "把能力差距，拆成一条能坚持的学习路线",
    description: "将关键差距拆解为阶段目标、行动任务、学习资源和验收标准。",
    nextHint: "选择能证明核心能力的作品集项目。",
  },
  projects: {
    step: 5,
    title: "用项目证明能力，而不只是写在简历里",
    description: "围绕目标岗位和能力短板，生成可完成、可验证、可展示的项目。",
    nextHint: "将项目成果转换为岗位相关的简历表达。",
  },
  resume: {
    step: 6,
    title: "让每一段经历，都更贴近目标岗位",
    description: "根据岗位关键词、能力差距和项目成果，优化简历中的证据与表达。",
    nextHint: "使用简历与项目上下文进入模拟面试。",
  },
  interview: {
    step: 7,
    title: "练习高频问题，也练习更有说服力的表达",
    description: "围绕目标岗位和项目经历进行结构化回答练习，并获得具体反馈。",
    nextHint: "将练习建议汇总到任务中心持续执行。",
  },
  tasks: {
    step: 8,
    title: "把建议变成行动，让进度每天都看得见",
    description: "集中跟踪学习、项目、简历和面试建议形成的执行任务。",
